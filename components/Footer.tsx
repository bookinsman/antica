          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="relative bg-gradient-to-br from-mustard/5 to-terracotta/5 border-2 border-terracotta/30 rounded-lg p-8 md:p-10">
              ...
              <div className="mt-4">
                ...
                {/* Special Conditions */}
                <div className="bg-gradient-to-r from-mustard/10 to-terracotta/10 rounded-md p-4 mb-4 border-2 border-terracotta/30">
                  <div className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-terracotta flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7" />
                    </svg>
                    <div>
                      <p className="text-xs font-black uppercase tracking-wider text-terracotta mb-2">
                        {t('b2bSpecialConditions')}
                      </p>
                      <p className="text-xs text-gray-700 font-light leading-relaxed">
                        {t('b2bSpecialConditionsDesc')}
                      </p>
                    </div>
                  </div>
                </div>
